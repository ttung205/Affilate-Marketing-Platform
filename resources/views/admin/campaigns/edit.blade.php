...
@section('title', 'Chỉnh sửa Campaign')
...
<div class="campaigns-container">
    ...
    <div class="campaigns-form-card">
        <div class="form-header">
            <h3 class="form-title">Chỉnh sửa thông tin Campaign</h3>
            <p class="form-subtitle">Cập nhật thông tin campaign "{{ $campaign->name }}"</p>
        </div>
        
        <div class="form-body">
            <form method="POST" action="{{ route('admin.campaigns.update', $campaign) }}" class="campaigns-form">
                @csrf
                @method('PUT')
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select @error('status') is-invalid @enderror" 
                            ...
                            <option value="draft" {{ old('status', $campaign->status) == 'draft' ? 'selected' : '' }}>Nháp</option>
                        ...
                        @error('status')
                            <div class="form-error">{{ $message }}</div>
                        @enderror
                        <div class="form-help">Trạng thái hiện tại của campaign</div>
                    </div>
                </div>
                ...
                <div class="form-group form-group-full">
                    ...
                    <textarea class="form-input @error('description') is-invalid @enderror" 
                              ...
                              name="description" 
                              rows="4" 
                              placeholder="Mô tả chi tiết về campaign...">{{ old('description', $campaign->description) }}</textarea>
                    @error('description')
                        <div class="form-error">{{ $message }}</div>
                    @enderror
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" 
                               ...
                               value="{{ old('commission_rate', $campaign->commission_rate) }}" 
                               min="0" 
                               max="100" 
                               step="0.01" 
                               placeholder="15.00" 
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" 
                               ...
                               id="cost_per_click" 
                               name="cost_per_click" 
                               value="{{ old('cost_per_click', $campaign->cost_per_click ?? 100.00) }}" 
                               min="0" 
                               step="10" 
                               placeholder="100.00" 
                               required>
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="number" 
                               ...
                               value="{{ old('target_conversions', $campaign->target_conversions) }}" 
                               min="0" 
                               placeholder="0">
