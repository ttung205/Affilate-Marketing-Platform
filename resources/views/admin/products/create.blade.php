        ...
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="product-form">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="price" name="price" value="{{ old('price') }}" class="form-input" placeholder="VD: 225205000" required>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="stock" name="stock" value="{{ old('stock', 0) }}" class="form-input" min="0" required>
                    @error('stock')
                        <span class="form-error">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" id="commission_rate" name="commission_rate" value="{{ old('commission_rate', 0) }}" class="form-input" min="0" max="100" step="0.01" required>
            ...
            <div class="form-group full-width">
                ...
                <input type="url" id="affiliate_link" name="affiliate_link" value="{{ old('affiliate_link') }}" class="form-input" placeholder="https://example.com/product">
